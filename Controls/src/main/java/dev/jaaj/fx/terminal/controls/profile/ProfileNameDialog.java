...
public class ProfileNameDialog extends TextInputDialog {
    public static final ResourceBundle BUNDLE = ResourceBundle.getBundle(ProfileForm.class.getPackageName() + ".Profile");

    public ProfileNameDialog(Profile profile) {
        super(profile.getProfileName());
        this.setTitle(BUNDLE.getString("rename"));
        this.setHeaderText(BUNDLE.getString("rename"));
        this.setContentText(BUNDLE.getString("profile_name"));
    }
}
